                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="single-listing-share2">
                                <div class="row gutters-15">
                                    <div class="col-4">
                                        <a href="#" class="item-btn"><i class="fas fa-share-alt"></i>Link</a>
                                    </div>
                                    <div class="col-4">
                                        <a href="#" class="item-btn"><i class="fas fa-share-alt"></i>Facebook</a>
                                    </div>
                                    <div class="col-4">
                                        <a href="#" class="item-btn"><i class="fas fa-share-alt"></i>whatsapp</a>
                                    </div>
                                </div>
                            </div>
                        </div>
