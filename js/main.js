    ...
    if (contactForm.length) {
        contactForm.validator().on('submit', function (e) {
            ...
            if (e.isDefaultPrevented()) {
                $target.html("<div class='alert alert-success'><p>Todos los campos son requeridos.</p></div>");
            } else {
                $.ajax({
                    ...
                    beforeSend: function () {
                        $target.html("<div class='alert alert-info'><p>Cargando ...</p></div>");
                    },
                    success: function (text) {
                        if (text === "success") {
                            $this[0].reset();
                            $target.html("<div class='alert alert-success'><p>El Mensaje ha sido enviado.</p></div>");
                        } else {
